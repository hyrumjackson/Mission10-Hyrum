...
namespace Mission10Backend.Migrations
{
    ...
    [Migration("20240315000542_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mission10Backend.Models.Bowler", b =>
                {
            ...
            modelBuilder.Entity("Mission10Backend.Models.BowlerScore", b =>
                {
            ...
            modelBuilder.Entity("Mission10Backend.Models.MatchGame", b =>
                {
                    b.Property<int>("MatchId")
                        .HasColumnType("INT")
                        .HasColumnName("MatchID");
            ...
            modelBuilder.Entity("Mission10Backend.Models.Team", b =>
                {
                    b.Property<int>("TeamId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INT")
            ...
            modelBuilder.Entity("Mission10Backend.Models.Tournament", b =>
                {
            ...
            modelBuilder.Entity("Mission10Backend.Models.TourneyMatch", b =>
                {
                    b.Property<int>("MatchId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INT")
            ...
            modelBuilder.Entity("Mission10Backend.Models.ZtblBowlerRating", b =>
                {
            ...
            modelBuilder.Entity("Mission10Backend.Models.ZtblSkipLabel", b =>
                {
            ...
            modelBuilder.Entity("Mission10Backend.Models.ZtblWeek", b =>
                {
            ...
            modelBuilder.Entity("Mission10Backend.Models.Bowler", b =>
                {
                    b.HasOne("Mission10Backend.Models.Team", "Team")
                        .WithMany("Bowlers")
            ...
            modelBuilder.Entity("Mission10Backend.Models.BowlerScore", b =>
                {
                    b.HasOne("Mission10Backend.Models.Bowler", "Bowler")
            ...
            modelBuilder.Entity("Mission10Backend.Models.MatchGame", b =>
                {
                    b.HasOne("Mission10Backend.Models.TourneyMatch", "Match")
                        .WithMany("MatchGames")
            ...
            modelBuilder.Entity("Mission10Backend.Models.TourneyMatch", b =>
                {
                    b.HasOne("Mission10Backend.Models.Team", "EvenLaneTeam")
                        .WithMany("TourneyMatchEvenLaneTeams")
                        .HasForeignKey("EvenLaneTeamId");

                    b.HasOne("Mission10Backend.Models.Team", "OddLaneTeam")
                        .WithMany("TourneyMatchOddLaneTeams")
                        .HasForeignKey("OddLaneTeamId");

                    b.HasOne("Mission10Backend.Models.Tournament", "Tourney")
